...
export default function About() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-12">
      ...
      {/* WRAPPER PUTIH BESAR (sesuai screenshot) */}
      <div className="bg-white rounded-2xl shadow-lg p-10">
        ...
        <div className="grid sm:grid-cols-2 gap-6 mt-10">
          ...
          {/* Health First */}
          <div className="rounded-xl bg-surface-100 border border-line-200 p-6 flex gap-4">
        ...
        {/* MISSION */}
        <div className="rounded-xl bg-surface-100 border border-line-200 p-6 mt-10">
